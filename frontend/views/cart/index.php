                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <?= Html::img(Yii::getAlias('@frontendWeb') . $book->imageFile, [
                                            'class' => 'img-fluid',
                                            'alt' => 'Book Image'
                                        ]) ?>
                                    </div>
                                    <div class="col-md-8">
                                        <p><strong>Description:</strong> <?= Html::encode($book->description) ?></p>
                                        <p><strong>Authors:</strong>
                                            <?php foreach ($book->authors as $author): ?>
                                                <?= Html::encode($author->first_name . ' ' . $author->last_name) ?><br>
                                            <?php endforeach; ?>
                                        </p>
                                        <p><strong>Price:</strong> <?= Yii::$app->formatter->asCurrency($book->price) ?></p>
                                        <p><strong>Quantity:</strong> <?= Html::encode($model->quantity) ?></p>
                                        <p><strong>Total:</strong> <?= Yii::$app->formatter->asCurrency($book->price * $model->quantity) ?></p>
                                    </div>
                                </div>
                            </div>
